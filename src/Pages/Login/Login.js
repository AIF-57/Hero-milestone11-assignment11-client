...
const Login = () => {
    ...
    return (
        <div className='lg:h-[80vh] grid lg:grid-cols-2 items-center py-10 lg:py-0 mx-5'>
            ...
            <div className="loginForm grid grid-cols-1 justify-center items-center">
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col items-center'>
                    ...
                    <input type="submit" value='LOGIN' className='w-[80%] lg:w-[60%] h-10 px-2 rounded bg-blue-700 text-white font-bold cursor-pointer' />
                    <span className='my-4 text-sm font-bold'>or</span>
                    <div className="socialLogin w-[80%] lg:w-3/6 rounded-full h-10 bg-white px-2 cursor-pointer border border-gray-300">
